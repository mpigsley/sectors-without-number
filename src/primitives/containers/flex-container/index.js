...
FlexContainer.propTypes = {
  ...
  align: PropTypes.oneOf(['stretch', 'center', 'flexStart', 'flexEnd', 'baseline', 'initial', 'inherit']),
  justify: PropTypes.oneOf(['flexStart', 'flexEnd', 'center', 'spaceBetween', 'spaceAround', 'initial', 'inherit']),
